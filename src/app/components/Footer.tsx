      ...
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 1440 524.272">
        ...
        <defs>
          ...
          <radialGradient cx="0" cy="0" gradientTransform="translate(975.263 -46.2715) rotate(86.9805) scale(708.489 642.198)" gradientUnits="userSpaceOnUse" id="paint0_radial_1_1042" r="1">
            <stop offset="0.625" stopColor="#151515" />
  ...
  return (
    <div className="h-[10.141px] relative shrink-0 w-[7.606px]" data-name="arrow-accent">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 7.60585 10.1411">
        <g id="arrow-accent">
          <path d={svgPaths.p2d9a9e00} fill="var(--fill-0, #B8A7A7)" id="accent" />
        </g>
      </svg>
    </div>
  );
...
function Primary2() {
  return (
    <div className="absolute bg-white content-stretch flex gap-[5.071px] items-center justify-center left-0 px-[20.282px] py-[10.141px] rounded-[5.071px] top-[137.24px] cursor-pointer hover:bg-gray-200 transition-colors" data-name="primary">
      <p className="font-['Instrument_Sans',sans-serif] font-semibold leading-[normal] relative shrink-0 text-[10.141px] text-black" style={{ fontVariationSettings: "'wdth' 100" }}>
        Get started
      </p>
      <ArrowAccent2 />
    </div>
  ...
  return (
    <div className="content-stretch flex flex-col h-[373.981px] items-start justify-between relative shrink-0 w-[295.922px]" data-name="brand-info">
      <div className="h-[182.913px] relative shrink-0 w-full" data-name="header">
        <div className="absolute h-[106.019px] left-0 top-0 w-[295.922px]" data-name="brand">
          <div className="absolute content-stretch flex gap-[9.934px] items-center left-0 top-0" data-name="identity">
            <p className="font-['Inter',sans-serif] font-semibold leading-[normal] not-italic relative shrink-0 text-[26.49px] text-white">Z1</p>
          </div>
          <p className="absolute font-['Instrument_Sans',sans-serif] font-normal leading-[normal] left-0 text-[16.311px] text-white top-[40.78px] w-[489.32px] whitespace-pre-wrap" style={{ fontVariationSettings: "'wdth' 100" }}>
      ...
      <div className="content-stretch flex gap-[18.641px] items-center relative shrink-0" data-name="follow-cta">
        <p className="font-['Inter',sans-serif] font-semibold leading-[normal] not-italic relative shrink-0 text-[18.641px] text-white">Follow us on:</p>
        <div className="content-stretch flex gap-[18.641px] items-center relative shrink-0" data-name="socials">
          ...
          <div className="overflow-clip relative shrink-0 size-[37.282px]">
            <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 37.2816 37.2816">
              <g id="Group">
                <path clipRule="evenodd" d={svgPaths.p1e4e88a0} fill="var(--fill-0, #DCDCDC)" fillRule="evenodd" id="Vector_2" />
              </g>
            </svg>
          </div>
          {/* LinkedIn */}
          <div className="relative shrink-0 size-[37.282px]">
            <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 37.2816 37.2816">
              <path d={svgPaths.pbf41100} fill="var(--fill-0, #DCDCDC)" id="Vector" />
            </svg>
          </div>
          {/* Reddit */}
          <div className="relative shrink-0 size-[37.282px]">
            <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 37.2816 37.2816">
              <path d={svgPaths.p314c4d80} fill="var(--fill-0, #DCDCDC)" id="Vector" />
            </svg>
          </div>
        </div>
      </div>
...
function LinkGroup({ title, links }: { title: string, links: string[] }) {
  return (
    <div className="content-stretch flex flex-col gap-[18.641px] items-start relative shrink-0 whitespace-pre-wrap">
      <p className="font-['Instrument_Sans',sans-serif] font-semibold relative shrink-0 text-white w-full" style={{ fontVariationSettings: "'wdth' 100" }}>
        {title}
      </p>
      {links.map(link => (
        <p key={link} className="font-['Instrument_Sans',sans-serif] font-normal relative shrink-0 text-[#dcdcdc] w-full cursor-pointer hover:text-white" style={{ fontVariationSettings: "'wdth' 100" }}>
          {link}
        </p>
      ))}
    </div>
...
function LinkGroups() {
  return (
    <div className="content-stretch flex flex-col md:flex-row gap-8 md:gap-[74.563px] items-start leading-[normal] relative shrink-0 text-[16.311px] w-full md:w-auto" data-name="link-groups">
...
function Main() {
  return (
    <div className="relative shrink-0 w-full" data-name="main">
      <div className="content-stretch flex flex-col md:flex-row items-start justify-between px-4 md:px-[74.563px] py-[46.602px] relative w-full gap-8 md:gap-0">
        <BrandInfo />
        <LinkGroups />
      </div>
    </div>
  ...
  return (
    <div className="relative shrink-0 w-full" data-name="copyright-legal">
      <div className="flex flex-row items-center size-full">
        <div className="content-stretch flex flex-col md:flex-row font-['Instrument_Sans',sans-serif] font-normal items-center justify-between leading-[normal] pb-[37.282px] px-4 md:px-[74.563px] relative text-[#dcdcdc] text-[14px] md:text-[16.311px] w-full border-t border-gray-700 pt-8 mt-8 gap-4 md:gap-0">
          ...
          <div className="content-stretch flex gap-[37.282px] items-center relative shrink-0">
            <p className="relative shrink-0 cursor-pointer hover:text-white">Privacy</p>
            <p className="relative shrink-0 cursor-pointer hover:text-white">Terms</p>
          </div>
        </div>
      </div>
    </div>
...
export function Footer() {
  return (
    <div className="relative bg-[#1d1d1d] w-full max-w-[1440px] mx-auto overflow-hidden rounded-t-[27.961px] mt-20">
      <AccentContainer />
      <Main />
      <CopyrightLegal />
    </div>
